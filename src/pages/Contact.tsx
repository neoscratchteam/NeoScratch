            ...
            <div className="lg:col-span-7 bg-white border border-[#1a73e8]/20 rounded-3xl p-8 lg:p-12 shadow-2xl shadow-blue-500/5 animate-scale-in">
              ...
              <form onSubmit={handleSendToWhatsApp} className="space-y-8">
                ...
                <Button
                  ...
                  disabled={sending}
                >
                  {sending ? 'Processing Inguiry...' : 'Connect via WhatsApp'}
      ...
      <section className="py-24 bg-[#f8fafc] border-t border-border/40">
         <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-8 lg:gap-16">
               ...
               <a href="/projects" className="text-foreground/60 hover:text-[#1a73e8] text-[13px] font-bold flex items-center transition-colors">Browse Projects <ArrowRight className="ml-2 h-4 w-4" /></a>
            </div>
         </div>
      </section>
    </div>
