...
export function TeamClient() {
  return (
    <div className="min-h-screen bg-white font-jakarta text-[#060606] flex flex-col justify-between">
      <Header />

      <main className="pt-32 pb-24 sm:pt-40 sm:pb-32 px-4 sm:px-6 lg:px-8">
