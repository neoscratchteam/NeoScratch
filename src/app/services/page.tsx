...
const servicesJsonLd = [
  {
    ...
    description: 'Full SEO setup, Google Business Profile takeover, keyword indexing, and metadata optimization.',
    offers: {
      '@type': 'Offer',
      price: '50000',
      priceCurrency: 'RWF',
      description: '50,000 RWF full',
    },
    areaServed: 'RW',
  },
  {
    '@context': 'https://schema.org',
    '@type': 'Service',
    name: 'Business Website & System Development',
    provider: { '@type': 'Organization', name: 'NeoScratch' },
    description: 'Professional, custom web applications and business systems.',
    offers: {
      '@type': 'Offer',
      price: '350000',
      priceCurrency: 'RWF',
      description: 'Starting from 350,000 RWF for Business Systems',
    },
    areaServed: 'RW',
  },
  {
    ...
    provider: { '@type': 'Organization', name: 'NeoScratch' },
    description: 'Custom e-commerce platforms with admin dashboard, MTN MoMo & Airtel Money checkouts, starting from 200,000 RWF.',
    offers: {
      '@type': 'AggregateOffer',
      priceCurrency: 'RWF',
      lowPrice: '200000',
